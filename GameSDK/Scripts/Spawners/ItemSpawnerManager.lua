	...
	itemCategories =
	{
...

		{
			...
			classes =
			{
				...
				{ category = "Shotgun870TacticalWithMagazines", percent = 10 },
				{ category = "TranquilizerGunWithDarts", percent = 10 },
				{ category = "MP5WithMagazines", percent = 5 },
				{ category = "RandomAccessory", percent = 6 },
				{ category = "PX4WithMagazines", percent = 7.4 },
				{ category = "AA12WithMagazines", percent = 8 },
				...
				{ category = "M97WithRounds", percent = 0.6 },
		...
		-- Special Military Spawner
		{
			...
			classes =
			{
				...
				{ category = "RandomMilitaryClothing", percent = 12 },
				{ category = "RandomMilitaryGrenade", percent = 15 },
				{ category = "RandomMilitaryWeaponWithMagazines", percent = 34 },
		...
		-- Civilian Hunting Weapons
		{
			...
			classes =
			{
				{ category = "Rem700WithRounds", percent = 20 },
				{ category = "Rem870WithRounds", percent = 35 },
				{ category = "Sako85WithRounds", percent = 20 },
				{ category = "CrossbowWithMagazines", percent = 20 },
		...
		{
			category = "AK5DMagazines",
			classes =
			{
				{ class = "556x30_ak5d", percent = 75 },
				{ class = "ext_556x75", percent = 25 },
			},
		},

		{
			category = "AKMagazines",
			classes =
			{
				{ class = "762x30", percent = 75 },
				{ class = "ext_762x75", percent = 25 },
			},
		},

		{
			category = "AKValMagazines",
			classes =
			{
				{ class = "762x20_Akval", percent = 75 },
				{ class = "ext_762x30", percent = 25 },
			},
		},

		{
			category = "STANAGMagazines",
			classes =
			{
				{ class = "STANAGx30", percent = 75 },
				{ class = "ext_556x75", percent = 25 },
			},
		},
		...
		{
			category = "MakarovWithMagazines",
			group =
			{
				{ class = "Makarov" },
				{ class = "9mmx10_makarov" },
				{ class = "9mmx10_makarov" },
			},
		},
		...
		{
			category = "RandomRangedWithMagsPure",
			classes =
			{
				{ category = "AA12WithMagazines", percent = 0.1 },
				{ category = "ACAWWithMagazines", percent = 0.5 },
				{ category = "AK74UWithMagazines", percent = 1 },
				{ category = "AKMWithMagazines", percent = 0.5 },
				{ category = "AKMGoldWithMagazines", percent = 0.01 },
				{ category = "AP85WithMagazines", percent = 1 },
				{ category = "AT15WithMagazines", percent = 1.5 },
				{ category = "AUMP45WithMagazines", percent = 1 },
				{ category = "BulldogWithMagazines", percent = 1 },
				{ category = "ColtPytonWithRounds", percent = 8.9 },
				{ category = "ColtPythonGrimeyRickWithRounds", percent = 0.1 },
				{ category = "CraftedBowWithMagazines", percent = 2 },
				{ category = "CrossbowWithMagazines", percent = 2 },
				{ category = "CX4StormWithMagazines", percent = 1 },
				{ category = "FlareGunWithRounds", percent = 2 },
				{ category = "G18PistolWithMagazines", percent = 2 },
				{ category = "HK45WithMagazines", percent = 2 },
				{ category = "KrissVWithMagazines", percent = 1 },
				{ category = "M16WithMagazines", percent = 0.75 },
				{ category = "M1911WithMagazines", percent = 7 },
				{ category = "M249WithMagazines", percent = 0.01 },
				{ category = "M40A5WithMagazines", percent = 0.48 },
				{ category = "M9A1WithMagazines", percent = 1 },
				{ category = "MakarovWithMagazines", percent = 1.5 },
				{ category = "Mk18WithMagazines", percent = 1.2 },
				{ category = "Mk18ReaverWithMagazines", percent = 0.02 },
				{ category = "Model70WithRounds", percent = 2.7 },
				{ category = "MP5WithMagazines", percent = 1.5 },
				{ category = "P350WithMagazines", percent = 2 },
				{ category = "PX4WithMagazines", percent = 2 },
				{ category = "R90WithMagazines", percent = 1.3 },
				{ category = "RecurveBowWithMagazines", percent = 3 },
				{ category = "Rem700WithRounds", percent = 1.75 },
				{ category = "Rem870WithRounds", percent = 5 },
				{ category = "Ruger22WithMagazines", percent = 6 },
				{ category = "Sako85WithRounds", percent = 1 },
				{ category = "Shotgun870TacticalWithMagazines", percent = 2 },
				{ category = "TranquilizerGunWithDarts", percent = 3 },
				{ category = "Wasteland22WithRounds", percent = 6 },
				{ category = "AkValWithMagazines", percent = 1 },
				{ category = "SAS12WithRounds", percent = 1 },
				{ category = "MAK10WithRounds", percent = 1 },
				{ category = "AK5DWithMagazines", percent = 1 },
...

		{
			...
			classes =
			{
				{ category = "RandomRangedWithMagsPure", percent = 86 },
...

		{
			...
			classes =
			{
				...
				{ category = "RandomWeaponRepairKit", percent = 0 },
			},
		},
...

		{
			...
			{
				{ category = "RandomWeaponWithMagsPure", percent = 10 },
				{ category = "RandomToolRepairKit", percent = 0 },
...

		{
			...
			classes =
			{
				...
				{ category = "RandomNormalRepairKit", percent = 0 },
				{ category = "RandomWeaponWithMagsPure", percent = 10 },
...

		{
			...
			classes =
			{
				...
				{ category = "RandomWeaponWithMagsPure", percent = 5 },
...

		{
			...
			classes =
			{
				{ category = "RandomWeaponWithMagsPure", percent = 25 },
...

		{
			...
			classes =
			{
				...
				{ category = "RandomWeaponWithMagsPure", percent = 15 },
			},
		},
